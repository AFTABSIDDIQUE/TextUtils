  ...
  return (
    <>
       <div className='container my-3' style={{color: props.mode==='dark'?'white':'black'}}>
        <h1>{props.heading}</h1>
       <div className="mb-3">
            <textarea className="form-control" id="myBox" style={{backgroundColor: props.mode==='dark'?'lightgrey':'white',color:props.mode==='dark'?'white':'black'}}  rows="8" placeholder='Enter the Text in TextBox' value={text} onChange={handleOnClick} ></textarea>
        </div>
        ...
        <div className='container my-3'style={{color: props.mode==='dark'?'white':'black'}}>
            ...
            <p>{0.008*text.split(" ").filter((element)=>{return element.length!==0}).length} Minutes to Read a Word </p>
            <h2>Preview</h2>
